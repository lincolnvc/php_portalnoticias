...
<section class="<?php echo implode(' ', $classes); ?>">
	...
	<?php if (Bunyad::options()->user_rating): ?>
		...
		<li class="user-ratings<?php echo (!Bunyad::reviews()->can_rate() ? ' voted' : ''); ?>" data-post-id="<?php echo get_the_ID(); ?>">
			<span class="label"><?php _e('Avalia&ccedil;&atilde;o dos Usu&aacute;rios', 'bunyad'); ?> <span class="votes">(<?php 
				printf(__('%s Votos', 'bunyad'), '<span class="number">' . Bunyad::reviews()->votes_count() . '</span>'); ?>)</span>
			</span>
